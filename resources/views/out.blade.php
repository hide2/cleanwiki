...
<head>
    <meta charset="utf-8">
    <title>您使用的浏览器已经该进博物馆</title>
    <meta name="description" content="您的浏览器已经该进博物馆啦，请安装并使用现代浏览器">
    <meta name="author" content="极客标签 - gbtags.com">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <!-- Icons -->
    <link rel="shortcut icon" href="http://www.gbtags.com/gb/networks/themes/img/gbin1.ico">
    <!-- Styles -->
    <link rel="stylesheet" href="http://www.gbtags.com/gb/networks/update-browser/css/outdatedBrowser.min.css">

    <link rel="stylesheet" href="http://www.gbtags.com/gb/networks/update-browser/css/mobile.min.css">

    <!--[if lte IE 9]>
        <script src="http://cdn.gbtags.com/html5shiv/3.7.2/html5shiv.min.js"></script>
        <link rel="stylesheet" type="text/css" href="update-browser/css/ie9-and-down.min.css">
    <![endif]-->

    <!--[if lte IE 8]>
        <link rel="stylesheet" type="text/css" href="update-browser/css/ie8-and-down.min.css">
    <![endif]-->

    <script src="http://cdn.gbtags.com/modernizr/2.6.2/modernizr.min.js"></script>
    <noscript>
        <style type="text/css">
    ...
    <div class="inner">
        ...
        <header class="title" role="banner">
            <div class="browserVersion newBrowser">
                <h1>您目前使用的浏览器该进博物馆啦~~~</h1>
                <p>为了更佳的浏览体验，请使用现代浏览器访问本站</p>
            </div>
        ...
        <section class="c_browsers sorted kwicks kwicks-horizontal hideBrowsers">
            ...
            <div id="chrome" class="browser" rel="">
                <h3 class="statistic"><span>46.5%</span> 的互联网用户在使用 <br>此款浏览器</h3>
                <div class="center">
            ...
            <div id="firefox" class="browser" rel="">
                <h3 class="statistic"><span>16.5%</span> 的互联网用户在使用 <br>此款浏览器</h3>
                <div class="center">
            ...
            <div id="internetExplorer" class="browser" rel="">
                <h3 class="statistic"><span>21.6%</span> 的互联网用户在使用 <br>此款浏览器</h3>
                <div class="center">
                    <h2><span></span> INTERNET EXPLORER</h2>
                    <div class="download">
                        <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie" target="_blank" class="browserlink" data-track="Internet Explorer">下载</a>
            ...
            <div id="safari" class="browser" rel="">
                <h3 class="statistic"><span>10.3%</span> 的互联网用户在使用 <br>此款浏览器</h3>
                <div class="center">
            ...
            <div id="opera" class="browser" rel="">
                <h3 class="statistic"><span>1.5%</span> 的互联网用户在使用 <br>此款浏览器</h3>
                <div class="center">
...
<!-- end .pusher -->
    ...
    <!-- ============= SCRIPTS ============= -->
    <script src="http://cdn.gbtags.com/jquery/1.10.1/jquery.min.js"></script>
    <script src="http://www.gbtags.com/gb/networks/update-browser/js/outdatedBrowser.min.js"></script>

    <!--[if !IE]><!-->
      <script type="text/javascript" src="http://www.gbtags.com/gb/networks/update-browser/js/main.min.js"></script>
    <!--<![endif]-->

    <!--[if gte IE 9]>
      <script type="text/javascript" src="update-browser/js/main.min.js"></script>
    <![endif]-->
